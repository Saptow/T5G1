...
# COUNTRY_LABELS = {
#     "ARE": "United Arab Emirates", "AUS": "Australia", "CHE": "Switzerland", "CHN": "China",
...
#                 dbc.Button("Exports", id='btn-export1c', n_clicks=0, outline=True, size='sm', style={'border': '1px solid #ccc'}),
#                 dbc.Button("Imports", id='btn-import1c', n_clicks=0, outline=True, size='sm', style={'border': '1px solid #ccc'})
#             ], className='w-100')
#         ], className="col-md-6")
#     ], className="row mb-4"),
...
#     Input('module1c-tabs', 'value')
# )
# def update_all_visualizations(selected_country, trade_type, selected_sector, tab):
#     if tab == 'prediction':
#         data_source = pd.read_csv('sample_2026.csv')
#         data_source = data_source[data_source['scenario'] == 'postshock'].copy()
#         data_source.drop(columns=['scenario'], inplace=True)
#         data_source = data_source[df.columns]  # align columns
#     else:
#         data_source = df
